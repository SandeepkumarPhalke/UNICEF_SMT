Feature: Users tab in SMT application for Country Admin user
  ...
  Scenario Outline: Verify user is able to add Store Operator Read Only role active user
  ...
  Scenario Outline: Verify user is able to update Store Operator Read Only role active user
  	Given User click on "Edit User" button
   	Then  User navigates to create user page
  ...
  Scenario Outline: Verify user is able to add Store Operator Read Only role inactive, without email alerts user
  	Given User click on "Create New User" button
   	Then  User navigates to create user page
   	And   User enter "Automation" in "firstName"
   	And   User enter "Testing" in "lastName"
